"""Loads fixture JSON files. The committed corpus under fixtures/ is
synthetic: placeholder people, placeholder topics, no real chat. A replay set
built from real history belongs outside the repository and is passed with
--fixtures-dir, exactly as eval_critic does it."""

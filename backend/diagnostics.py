...
DIAGNOSTIC_DESCRIPTION = (
    ...
    "pipeline stage - durations and counts only, never what was said), "
    ...
    "or \"conversation_performance\" (why THIS conversation is fast or "
    "slow, regardless of modality: context weight by component, megabytes "
    "re-uploaded every turn, recent turn latencies, and voice stage "
    "latencies when the chat has used voice). "
        ...
        "properties": {
            "name": {
                ...
                "description": (
                    ...
                    "+ content-free stage latency percentiles), "

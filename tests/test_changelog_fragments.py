"""Changelog fragments: two open PRs must never conflict on CHANGELOG.md (#277).
...
FROZEN_SHA = "f66f9e2f2c9aa1503603511fc6fdccf1f552084c97a8d595acd62ed860614c84"
...
def test_fragment_rules_name_each_problem():
    ...
    once and plainly."""
    mod = _fold()
    assert mod.fragment_problems("277-changelog-fragments.md",
                                 "- One entry (#277).\n  Indented tail.\n") == []
